...
class Parser:
    ...
    def _r_choice_0(self):
        self._h_scope([
            self._r_choice_1, self._r_choice_2, self._r_choice_3
        ])
    ...
    def _r_comment_1(self):
        self._h_seq([lambda: self._h_str('//'), self._r_comment_3])
    ...
    def _r_dqchar_1(self):
        self._h_scope([
            self._r_bslash_0, self._r_dqchar_3, self._r_dqchar_4
        ])

    def _r_dqchar_2(self):
        self._h_scope([
            self._r_dqchar_5, self._r_dqchar_6, self._r_dqchar_7
        ])
    ...
    def _r_esc_char_1(self):
        self._h_seq([lambda: self._h_ch('b'), self._r_esc_char_15])

    def _r_esc_char_2(self):
        self._h_seq([lambda: self._h_ch('d'), self._r_esc_char_16])

    def _r_esc_char_3(self):
        self._h_seq([lambda: self._h_ch('f'), self._r_esc_char_17])

    def _r_esc_char_4(self):
        self._h_seq([lambda: self._h_ch('n'), self._r_esc_char_18])

    def _r_esc_char_5(self):
        self._h_seq([lambda: self._h_ch('r'), self._r_esc_char_19])

    def _r_esc_char_6(self):
        self._h_seq([lambda: self._h_ch('s'), self._r_esc_char_20])

    def _r_esc_char_7(self):
        self._h_seq([lambda: self._h_ch('t'), self._r_esc_char_21])

    def _r_esc_char_8(self):
        self._h_seq([lambda: self._h_ch('v'), self._r_esc_char_22])

    def _r_esc_char_9(self):
        self._h_seq([lambda: self._h_ch('w'), self._r_esc_char_23])
    ...
    def _r_esc_char_13(self):
        self._h_scope([self._r_esc_char_27, self._r_esc_char_28])

    def _r_esc_char_14(self):
        self._h_scope([self._r_esc_char_29, self._r_esc_char_30])
    ...
    def _r_hex_0(self):
        self._h_choice([self._r_digit_0, self._r_hex_1, self._r_hex_2])
    ...
    def _r_hex_esc_0(self):
        self._h_scope([
            lambda: self._h_ch('x'), self._r_hex_esc_1, self._r_hex_esc_2
        ])
    ...
    def _r_id_start_0(self):
        self._h_choice([
            self._r_id_start_1, self._r_id_start_2, lambda: self._h_ch('_')
        ])
    ...
    def _r_ll_exprs_1(self):
        self._h_scope([
            self._r_ll_exprs_3, self._r_ll_exprs_4, self._r_ll_exprs_5
        ])
    ...
    def _r_ll_prim_1(self):
        self._h_scope([self._r_ll_prim_7, self._r_ll_prim_8])
    ...
    def _r_ll_prim_3(self):
        self._h_scope([self._r_ll_prim_11, self._r_ll_prim_12])

    def _r_ll_prim_4(self):
        self._h_scope([self._r_ll_prim_13, self._r_ll_prim_14])
    ...
    def _r_ll_qual_1(self):
        self._h_scope([
            self._r_ll_qual_2, self._r_ll_qual_3, self._r_ll_qual_4
        ])
    ...
    def _r_post_expr_1(self):
        self._h_scope([
            self._r_post_expr_3, self._r_post_expr_4, self._r_post_expr_5
        ])

    def _r_post_expr_2(self):
        self._h_scope([self._r_post_expr_6, self._r_post_expr_7])
    ...
    def _r_post_op_0(self):
        self._h_choice([
            self._r_post_op_1, self._r_post_op_2, self._r_post_op_3
        ])

    def _r_post_op_1(self):
        self._h_seq([lambda: self._h_ch('?'), self._r_post_op_4])

    def _r_post_op_2(self):
        self._h_seq([lambda: self._h_ch('*'), self._r_post_op_5])

    def _r_post_op_3(self):
        self._h_seq([lambda: self._h_ch('+'), self._r_post_op_6])
    ...
    def _r_prim_expr_2(self):
        self._h_scope([self._r_prim_expr_14, self._r_prim_expr_15])
    ...
    def _r_prim_expr_7(self):
        self._h_seq([lambda: self._h_str('{}'), self._r_prim_expr_25])
    ...
    def _r_prim_expr_33(self):
        self._h_seq([self._r_sp_0, lambda: self._h_ch('=')])
    ...
    def _r_seq_1(self):
        self._h_scope([self._r_seq_3, self._r_seq_4, self._r_seq_5])
    ...
    def _r_seq_8(self):
        self._h_seq([self._r_ws_0, self._r_sp_0, self._r_expr_0])
    ...
    def _r_sqchar_1(self):
        self._h_scope([
            self._r_bslash_0, self._r_sqchar_3, self._r_sqchar_4
        ])

    def _r_sqchar_2(self):
        self._h_scope([
            self._r_sqchar_5, self._r_sqchar_6, self._r_sqchar_7
        ])
    ...
    def _r_unicode_esc_9(self):
        self._h_seq([
            self._r_hex_0, self._r_hex_0, self._r_hex_0, self._r_hex_0
        ])
